...
def main():
    ...
    point_2D = draw_rectangle(cam_matrix, target1, image)
    draw_rectangle(cam_matrix, target2, image)
    draw_rectangle(cam_matrix, target3, image)
